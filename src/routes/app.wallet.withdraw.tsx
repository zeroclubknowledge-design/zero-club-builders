  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24 transition-colors duration-300 px-6">
      <header className="flex items-center gap-4 pt-[calc(2rem+env(safe-area-inset-top))] pb-6">
        ...
        <h1 className="text-2xl font-black tracking-tight text-foreground">Withdraw Funds</h1>
      </header>

      <div className="flex flex-col gap-6 pt-4 text-foreground max-w-md mx-auto">
        <div className="rounded-3xl bg-primary/5 p-6 border border-primary/10 shadow-sm">
          <p className="text-sm leading-relaxed text-primary font-bold">
            Withdrawals are securely processed and typically arrive within 24 hours.
          </p>
        </div>

        <div className="space-y-2 mt-2">
          <label className="text-[11px] text-muted-foreground uppercase font-bold tracking-wider ml-1">Amount to withdraw</label>
