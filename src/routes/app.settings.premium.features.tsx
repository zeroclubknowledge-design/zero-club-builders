...
const planFeatures: Record<string, string[]> = {
  ...
  creator: ["Relevant Learner Premium experience", "5 rewarded Zero Games competitions weekly", "Create and manage 3 permanent Clubs", "Club customization and member management", "Moderation and analytics", "Community growth and activity insights", "First Club receives 6 months premium experience", "Creator Rewards eligibility"],
  ...
  tutor_premium: ["Everything in Tutor Basic", "5 rewarded Zero Games competitions weekly", "Create up to 5 permanent Clubs", "Connect Bootcamps to existing Clubs", "Zero AI knowledge interview", "Approved Bootcamp verification", "Zero AI curriculum and teaching assistance"],
  tutor_premium_plus: ["Everything in Tutor Premium", "14 rewarded Zero Games competitions weekly, maximum 2 daily", "Create up to 10 permanent Clubs", "Advanced Zero AI cohort assistance", "Multi-Bootcamp verification support", "Unlimited existing-Club connections", "Priority interview access and tutor support"],
  institution: ["30-day Digital Hub trial", "Zero Games allowance based on organisation size", "Tutor and role management", "Multi-Bootcamp oversight", "Cohort participation analytics", "Organisation-specific Club capacity", "Priority onboarding and support"],
};
