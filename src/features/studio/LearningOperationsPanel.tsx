    ...
    <div className="space-y-6">
      ...
      {tab === "cohorts" && (
        <div className="space-y-5">
          ...
          {showCohortForm && (
            <form onSubmit={createCohort} className="grid gap-4 rounded-lg border border-border bg-card p-5 md:grid-cols-2 lg:grid-cols-4">
          ...
          {cohortsQuery.isLoading ? <LoadingBlock /> : cohorts.length === 0 ? <EmptyBlock Icon={LayoutGrid} title="No cohorts yet" body="Create the first intake for one of your bootcamps." /> : (
            <div className="grid gap-4 lg:grid-cols-[minmax(250px,0.8fr)_minmax(0,1.5fr)]">
